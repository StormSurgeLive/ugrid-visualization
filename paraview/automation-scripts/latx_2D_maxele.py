...
'''
PURPOSE:
Generate a figure of bathymetry/topography and water surface elevation from an overhead 2D
...
ARGUMENTS:
    ...
    Argument 5: A string that defines a contact email to be displayed in the visualization
...
'''
EXAMPLE USAGE:
Suppose you have saved the paths for the 5 arguments in shell variables ARG1, ARG2, ARG3, ARG4, and ARG5
and you have saved the path to your ParaView installation in shell variable PV_PATH

Then, usage of this script could look like this:
"$PV_PATH"/bin/pvpython latx_2D_maxele.py "$ARG1" "$ARG2" "$ARG3" "$ARG4" "$ARG5"

After running this, you should see the file "latx_2D_maxele_img.png" in your output directory
'''
...
textEmail.Text = 'Contact Email: ' + pvpy_args[5] 
...
# Save figure
SaveScreenshot(path.join(pvpy_args[2],"latx_2D_maxele_img.png"), renderView1, ImageResolution=[1450, 778])
